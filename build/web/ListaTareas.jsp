    ...
    <body>
        ...
        <section>
            <div id="todo">
                <div class="container">
                    <div class="row">
                        <c:set var="val" value="${LISTATAREAS}"/>
                        <c:choose>
                            <c:when test="${val.size() == 0}">
                                <h2 style="color: red; text-align: center; font-size: 4rem; margin-top: 80px;">AÚN NO HAY EXPERCIENCIAS :( </h2>
                            </c:when>
                                    ...
                                    <div class="card" id="tarjeta">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <span style="margin-right: 100px;"id="span" class="badge badge-pill badge-primary ">FECHA - ${varTempTarea.fecha}</span>
